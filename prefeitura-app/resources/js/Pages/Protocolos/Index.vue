        ...
        <table class="table-auto w-full">
            ...
            <tbody class="divide-y divide-gray-200">
                <tr v-for="protocolo in protocolos.data" v-bind="protocolo.id" class="hover:bg-slate-200">
                    ...
                    <td>{{ protocolo.departamento.id }} - {{ protocolo.departamento.nome }}</td>
                    <td class="text-center">{{ new Date(protocolo.created_at).toLocaleDateString('pt-BR', { timeZone: 'UTC'}) }}</td>
                    <td class="text-center">{{ protocolo.prazo }} dias</td>
                    <td v-if="protocolo.situacao === 0" class="text-center text-red-700 font-bold">Pendente</td>
                    ...
                    <td class="flex justify-center items-center space-x-1 py-0.5">
                        ...
                        <button @click="destroy(protocolo.id)" class="p-1 text-white rounded bg-rose-600/80 hover:bg-red-300">
