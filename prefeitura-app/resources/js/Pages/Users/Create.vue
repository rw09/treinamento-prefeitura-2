            ...
            <div class="mt-4 text-xs">
                ...
                <div class="flex justify-between mt-2">
                    <div v-if="perfil_acesso === 0">
                        <input v-model="form.perfil" class="align-middle mr-1" type="radio" id="admin-ti" name="dmin-ti" value="0">
                        <label class="align-bottom" for="admin-ti">Administrador TI</label>
                    </div>
                    <div v-if="perfil_acesso === 0">
                        <input v-model="form.perfil" class="align-middle mr-1" type="radio" id="admin-sistema" name="admin-sistema" value="1">
                        <label class="align-bottom" for="admin-sistema">Administrador Sistema</label>
                    </div>
                    <div>
                        <input v-model="form.perfil" v-bind:checked="perfil_acesso === 1" class="align-middle mr-1" type="radio" id="operador" name="operador" value="2">
